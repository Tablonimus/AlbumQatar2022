...
export default function Home() {
  ...
  return (
    <motion.div
      className=" bg-green-600 h-full w-full flex lg:flex-row flex-col items-center"
      // initial={{ opacity: 0 }}
      // animate={{ opacity: 0 }}
      // exit={{ opacity: 0 }}
    >
       <NavBar />
      <div className="mt-20">
        <img src={campo} alt="" className="shadow-lg rounded-lg" />
      </div>
      ...
      <div className=" w-full grid grid-cols-5 gap-1 m-2">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <motion.div
            ...
            className="shadow-lg"
          >
            <img onClick={onChino} src={chini} alt="js" width="100px"
            className="shadow-lg" />
          </motion.div>
        </div>
